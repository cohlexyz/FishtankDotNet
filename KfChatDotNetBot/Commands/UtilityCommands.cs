...
public class PPVCommand : ICommand
{
        ...
        CancellationToken ctx)
    {
        ...
        await botInstance.SendChatMessageAsync($"@{message.Author.Username}, restream URL: https://old.ppv.to/ft, MPV playlist: https://i.ddos.lgbt/u/fishtank-s5.m3u, Camera multiview: https://kiwifarms.st/posts/23969413", true);
    }
}